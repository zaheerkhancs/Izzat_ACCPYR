...
Public Class RptProvinces
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptProvinces.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptProvinces
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptProvinces = New RptProvinces
        rpt.Site = Me.Site
        Return rpt
    End Function
