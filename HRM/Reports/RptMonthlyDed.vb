...
Public Class RptMonthlyDed
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptMonthlyDed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMonthlyDed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMonthlyDed = New RptMonthlyDed
        rpt.Site = Me.Site
        Return rpt
    End Function
