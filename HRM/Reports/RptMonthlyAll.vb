...
Public Class RptMonthlyAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptMonthlyAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMonthlyAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMonthlyAll = New RptMonthlyAll
        rpt.Site = Me.Site
        Return rpt
    End Function
