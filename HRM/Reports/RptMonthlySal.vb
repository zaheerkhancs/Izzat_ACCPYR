...
Public Class RptMonthlySal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptMonthlySal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMonthlySal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMonthlySal = New RptMonthlySal
        rpt.Site = Me.Site
        Return rpt
    End Function
