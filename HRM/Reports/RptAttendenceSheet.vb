...
Public Class RptAttendenceSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptAttendenceSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptAttendenceSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptAttendenceSheet = New RptAttendenceSheet
        rpt.Site = Me.Site
        Return rpt
    End Function
