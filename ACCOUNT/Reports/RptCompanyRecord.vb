...
Public Class RptCompanyRecord
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptCompanyRecord.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCompanyRecord
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCompanyRecord = New RptCompanyRecord
        rpt.Site = Me.Site
        Return rpt
    End Function
