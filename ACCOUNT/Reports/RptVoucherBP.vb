...
Public Class RptVoucherBP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptVoucherBP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVoucherBP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVoucherBP = New RptVoucherBP
        rpt.Site = Me.Site
        Return rpt
    End Function
