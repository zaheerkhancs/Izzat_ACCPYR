...
Public Class RptBallanceSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptBallanceSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBallanceSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBallanceSheet = New RptBallanceSheet
        rpt.Site = Me.Site
        Return rpt
    End Function
