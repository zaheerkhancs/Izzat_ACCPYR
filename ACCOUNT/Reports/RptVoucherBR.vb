...
Public Class RptVoucherBR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptVoucherBR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVoucherBR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVoucherBR = New RptVoucherBR
        rpt.Site = Me.Site
        Return rpt
    End Function
