...
Public Class RptVoucherNoDate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptVoucherNoDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_WordTotal() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptVoucherNoDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVoucherNoDate = New RptVoucherNoDate
        rpt.Site = Me.Site
        Return rpt
    End Function
