...
Public Class DfrmPurchasePayment
    Public Var_FormIsOpen As Boolean
    Private Sub DfrmPurchasePayment_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        dtPayment.Value = Now
    End Sub
    ...
    Private Sub btnPay_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPay.Click
        If txtBalance.Text < 0 Then
            ...
            Exit Sub
        Else
            frmPurchase.txtPaid.Text = txtTotalPaid.Text
            frmPurchase.txtBalance.Text = txtBalance.Text
            Me.Visible = False
    ...
    Private Sub DfrmPurchasePayment_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
