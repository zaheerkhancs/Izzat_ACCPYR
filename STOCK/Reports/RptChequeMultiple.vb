...
Public Class RptChequeMultiple
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptChequeMultiple.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptChequeMultiple
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptChequeMultiple = New RptChequeMultiple
        rpt.Site = Me.Site
        Return rpt
    End Function
