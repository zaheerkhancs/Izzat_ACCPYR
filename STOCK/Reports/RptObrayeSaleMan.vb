...
Public Class RptObrayeSaleMan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptObrayeSaleMan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptObrayeSaleMan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptObrayeSaleMan = New RptObrayeSaleMan
        rpt.Site = Me.Site
        Return rpt
    End Function
