...
Public Class RptDamageFromUs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptDamageFromUs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDamageFromUs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDamageFromUs = New RptDamageFromUs
        rpt.Site = Me.Site
        Return rpt
    End Function
