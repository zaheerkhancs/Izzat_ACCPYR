...
Public Class RptDamageSaleMan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptDamageSaleMan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDamageSaleMan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDamageSaleMan = New RptDamageSaleMan
        rpt.Site = Me.Site
        Return rpt
    End Function
