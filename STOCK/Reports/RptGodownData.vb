...
Public Class RptGodownData
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptGodownData.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptGodownData
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptGodownData = New RptGodownData
        rpt.Site = Me.Site
        Return rpt
    End Function
