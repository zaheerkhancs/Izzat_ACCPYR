...
Public Class RptClaimEnglish
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptClaimEnglish.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptClaimEnglish
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptClaimEnglish = New RptClaimEnglish
        rpt.Site = Me.Site
        Return rpt
    End Function
