...
Public Class RptObrayeOffice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptObrayeOffice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptObrayeOffice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptObrayeOffice = New RptObrayeOffice
        rpt.Site = Me.Site
        Return rpt
    End Function
