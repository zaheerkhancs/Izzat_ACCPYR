...
Public Class RptObrayeOfSaleman
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptObrayeOfSaleman.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptObrayeOfSaleman
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptObrayeOfSaleman = New RptObrayeOfSaleman
        rpt.Site = Me.Site
        Return rpt
    End Function
