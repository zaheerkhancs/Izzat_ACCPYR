...
Public Class RptOderEnglish
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptOderEnglish.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptOderEnglish
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptOderEnglish = New RptOderEnglish
        rpt.Site = Me.Site
        Return rpt
    End Function
