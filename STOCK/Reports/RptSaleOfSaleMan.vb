...
Public Class RptSaleOfSaleMan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptSaleOfSaleMan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSaleOfSaleMan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSaleOfSaleMan = New RptSaleOfSaleMan
        rpt.Site = Me.Site
        Return rpt
    End Function
