...
Public Class RptSaleManSearch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IZAT_AFGHAN_LIMITED.RptSaleManSearch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSaleManSearch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSaleManSearch = New RptSaleManSearch
        rpt.Site = Me.Site
        Return rpt
    End Function
